...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/bundle/macos-jsonrpc': { kind: 'none', reason: 'The bundle is a patch-list carrier over base; prompts and tools belong to the base layer and configured agent presets.' },
